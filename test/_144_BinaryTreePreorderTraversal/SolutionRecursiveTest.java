...
public class SolutionRecursiveTest {
    ...
    /** Test method for {@link _144_BinaryTreePreorderTraversal.SolutionRecursive} */
    ...
    public void Test6() {
        ...
        List<Integer> actual = solution.preorderTraversal(root);
        List<Integer> expected = Arrays.asList(5, 4, 11, 7, 2, 8, 13, 4, 5, 1);
        assertEquals(expected, actual);
    }
    ...
    public void Test7() {
        ...
        List<Integer> actual = solution.preorderTraversal(root);
        List<Integer> expected = Arrays.asList(10, 5, 4, 7, 12);
        assertEquals(expected, actual);
    }
