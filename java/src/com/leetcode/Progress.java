...
public class Progress {
    ...
    private static final String INPUT_FILE = "scripts/leetcode.tsv";
    private static final String DEST_FILE = "problems.md";
    ...
    private String toGitURL(String num, String probName) {
        ...
        String urlStr = GIT_PREFIX + "_" + getGitNumber(num) +  "_" + name.toString() + GIT_SUFFIX;
        try {
            URL url;
            url = new URL(urlStr);
